...
### Fixed
- Fix `Null check operator used on a null value` error during connection process in `WuKongClient`
- Fix UI layout overflow issues in the example application
- Fix layout responsiveness for small screens in the example application

### Changed
- Complete redesign of the example application with modern Material 3 UI
- Enhanced logging system in example app with color-coded categories and better visualization
